class s{static generateCard(e,a="trading-card-canvas"){console.log("🌌 HolographicCardGeneratorMultiLayer received parameters:",e);const o={0:"tetrahedron",1:"hypercube",2:"sphere",3:"torus",4:"klein",5:"fractal",6:"wave",7:"crystal"}[e.geometry]||"hypercube",t=new Date().toISOString().replace(/[:.]/g,"-");console.log("🌌 Using geometry:",e.geometry,"→",o),console.log("🌌 GridDensity parameter:",e.gridDensity),console.log("🌌 Template literal values that will be baked into HTML:"),console.log("   geometry:",e.geometry||0),console.log("   speed:",e.speed||1),console.log("   intensity:",e.intensity||.6),console.log("   hue:",e.hue||320),console.log("   saturation:",e.saturation||.8),console.log("   morphFactor:",e.morphFactor||1),console.log("   chaos:",e.chaos||.2),console.log("   rot4dXW:",e.rot4dXW||0),console.log("   rot4dYW:",e.rot4dYW||0),console.log("   rot4dZW:",e.rot4dZW||0);const r=`<!DOCTYPE html>
<html>
<head>
    <title>VIB34D Multi-Layer Holographic Card - ${o}</title>
    <style>
        body { 
            margin: 0; 
            padding: 20px; 
...
</html>`;return{filename:`vib34d-holographic-multilayer-${o}-${t}.html`,content:r,system:"holographic-multilayer"}}}export{s as HolographicCardGeneratorMultiLayer};
